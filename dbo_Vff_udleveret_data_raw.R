...
#   3) at uploade tre RAW-tabeller til Azure SQL:
#        * dbo.dim_vff_klubber_raw
#        * dbo.fact_vff_billetsalg_raw_SQLite
#        * dbo.fact_vff_billetsalg_raw_RDS
...
# -------------------------------------------------------------------------
# Afsnit 6: Upload til Azure SQL
# Formål:
#   1) dim_vff_klubber_raw
#   2) fact_vff_billetsalg_raw_SQLite  (fra SQLite)
#   3) fact_vff_billetsalg_raw_RDS     (fra RDS)
# -------------------------------------------------------------------------
...
#   - klub-dimensionen (fra SQLite-masteren),
#   - billetsalg fra SQLite,
#   - billetsalg fra RDS-filen.
...
# Dette er kun til udvikling/validering – kan kommenteres ud i produktion,
# men er rart at have, når man vil være sikker på at upload er lykkedes.
