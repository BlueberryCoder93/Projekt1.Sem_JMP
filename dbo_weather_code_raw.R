...
#   5) Uploader hele RAW-dimensionen til Azure SQL som dbo.dim_weather_code_raw.
#
...
# =============================================================================
# Upload til Azure SQL (ingen Excel længere)
# =============================================================================
...
#
# Tabellen skrives til dbo.dim_weather_code_raw og overskrives ved hver kørsel,
